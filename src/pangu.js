...
(function webpackUniversalModuleDefinition(root, factory) {
  ...
  else if (typeof exports === "object") exports["pangu"] = factory();
  else root["pangu"] = factory();
})(window, function () {
    ...
    /******/ [
          ...
          var BrowserPangu = (function (_Pangu) {
            ...
            function BrowserPangu() {
              ...
              _this3 = _possibleConstructorReturn(
                this,
                _getPrototypeOf(BrowserPangu).call(this),
              );
            ...
            _createClass(BrowserPangu, [
              ...
              },
              {
                ...
                value: function isSpecificTag(node, tagRegex) {
                  return (
                    node && node.nodeName && node.nodeName.search(tagRegex) >= 0
                  );
                },
              },
              {
                ...
                value: function spacingNodeByXPath(xPathQuery, contextNode) {
                  ...
                  for (var i = textNodes.snapshotLength - 1; i > -1; --i) {
                    ...
                    if (
                      ...
                      if (elementNode.previousSibling) {
                        ...
                        if (previousSibling.nodeType === Node.TEXT_NODE) {
                          var testText =
                            previousSibling.data.substr(-1) +
                            currentTextNode.data.toString().charAt(0);
                      ...
                      if (elementNode.nextSibling) {
                        ...
                        if (nextSibling.nodeType === Node.TEXT_NODE) {
                          var _testText =
                            currentTextNode.data.substr(-1) +
                            nextSibling.data.toString().charAt(0);
                    ...
                    if (nextTextNode) {
                      ...
                      var _testText2 =
                        currentTextNode.data.toString().substr(-1) +
                        nextTextNode.data.toString().substr(0, 1);
                      ...
                      if (_testNewText2 !== _testText2) {
                        ...
                        while (
                          nextNode.parentNode &&
                          nextNode.nodeName.search(this.spaceSensitiveTags) ===
                            -1 &&
                        ...
                        if (currentNode.nextSibling) {
                          if (
                            currentNode.nextSibling.nodeName.search(
                              this.spaceLikeTags,
                            ) >= 0
                          ) {
                            nextTextNode = currentTextNode;
                        ...
                        if (
                          currentNode.nodeName.search(this.blockTags) === -1
                        ) {
                          if (
                            nextNode.nodeName.search(
                              this.spaceSensitiveTags,
                            ) === -1
                          ) {
                            if (
                              nextNode.nodeName.search(this.ignoredTags) ===
                                -1 &&
                              nextNode.nodeName.search(this.blockTags) === -1
                            ) {
                              if (nextTextNode.previousSibling) {
                                if (
                                  nextTextNode.previousSibling.nodeName.search(
                                    this.spaceLikeTags,
                                  ) === -1
                                ) {
                            ...
                            if (nextNode.previousSibling) {
                              if (
                                nextNode.previousSibling.nodeName.search(
                                  this.spaceLikeTags,
                                ) === -1
                              ) {
      ...
      /***/ function (module, exports, __webpack_require__) {
        ...
        (function (global, factory) {
          ...
          var CONVERT_TO_FULLWIDTH_CJK_SYMBOLS = new RegExp(
            "([".concat(CJK, "])[ ]*([~\\!;,\\?]+)[ ]*"),
            "g",
          );
          var DOTS_CJK = new RegExp(
            "([\\.]{2,}|\u2026)([".concat(CJK, "])"),
            "g",
          );
          var FIX_CJK_COLON_ANS = new RegExp(
            "([".concat(CJK, "])\\:([A-Z0-9\\(\\)])"),
            "g",
          );
          ...
          var CJK_SINGLE_QUOTE_BUT_POSSESSIVE = new RegExp(
            "([".concat(CJK, "])('[^s])"),
            "g",
          );
          var SINGLE_QUOTE_CJK = new RegExp("(')([".concat(CJK, "])"), "g");
          var FIX_POSSESSIVE_SINGLE_QUOTE = new RegExp(
            "([A-Za-z0-9".concat(CJK, "])( )('s)"),
            "g",
          );
          var HASH_ANS_CJK_HASH = new RegExp(
            "(["
              .concat(CJK, "])(#)([")
              .concat(CJK, "]+)(#)([")
              .concat(CJK, "])"),
          ...
          var CJK_OPERATOR_ANS = new RegExp(
            "([".concat(CJK, "])([\\+\\-\\*\\/=&\\|<>])([A-Za-z0-9])"),
            "g",
          );
          ...
          var CJK_LEFT_BRACKET = new RegExp(
            "([".concat(CJK, "])([\\(\\[\\{<>\u201C])"),
            "g",
          );
              ...
              },
              {
                ...
                value: function spacing(text) {
                  ...
                  newText = newText.replace(
                    ...
                    function (match, leftCjk, symbols, rightCjk) {
                      var fullwidthSymbols = self.convertToFullwidth(symbols);
                      return ""
                        .concat(leftCjk)
                        .concat(fullwidthSymbols)
                        .concat(rightCjk);
                    },
                  );
                  newText = newText.replace(
